...
//                    {
//                        Console.WriteLine(user.FirstName + " add in group");
...
//                });
//                await Clients.Group(GROUP_CHAT_PREFIX + chatEntity.ID).SendAsync("UpdateChatReply", chatEntity.AdminTag, new ChatModel
//                {
